...
describe('Check calculate experience', () => {
  it('When intelligence is default', () => {
    ...
    expect(module.calculateExperience(100)).toBe(calculateExperienceFormula(100, 1))
  })
  ...
  it('When intelligence 5', () => {
    ...
    expect(module.calculateExperience(100)).toBe(calculateExperienceFormula(100, 5))
  })
  ...
  it('When intelligence 10', () => {
    ...
    expect(module.calculateExperience(100)).toBe(calculateExperienceFormula(100, 10))
  })
})
