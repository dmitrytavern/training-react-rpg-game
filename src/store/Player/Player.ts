...
class Player {
  ...
  private initPlayerHealth() {
    ...
    this.health.setComputedFunction('effects', () => {
      return Player.calculateEffect('maxHealth', [...this.equipment.getEffects()])
    })
  ...
  private initPlayerEnergy() {
    ...
    this.energy.setComputedFunction('effects', () => {
      return Player.calculateEffect('maxEnergy', [...this.equipment.getEffects()])
    })
  ...
  private initPlayerDamage() {
    ...
    this.damage.setComputedFunction('effects', () => {
      return Player.calculateEffect('damage', [...this.equipment.getEffects()])
    })
  ...
  private initPlayerDefense() {
    ...
    this.defense.setComputedFunction('effects', () => {
      return Player.calculateEffect('defense', [...this.equipment.getEffects()])
    })
