...
class QuestsController {
  ...
  public getQuestGroups(status: QuestsGroupStatus) {
    switch (status) {
      case 'active': return this.quests.getActiveQuestGroups()
      case 'completed': return this.quests.getCompletedQuestGroups()
      case 'done': return this.quests.getDoneQuestGroups()
    }
  }
